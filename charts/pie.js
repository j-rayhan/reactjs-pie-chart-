...
module.exports = React.createClass({
  ...
  render: function() {
    ...
    const data1 =  mori.into( mori.vector(),this.props.data);

  // var selected1 = mori.find(data1, function(c, i) {
      // return 1;
    // });

    var selected = _.find(this.props.data, function(c, i) {
          console.log('selected data ',c);
    ...
    return(
      <div id="pie">
        <svg width="875" height="1200">
          <g transform="translate(600, 400)">{ slices }</g>
        </svg>
